...
export const ForbiddenAccess = () => {
  ...
  return (
    <div className="forbidden-access">
      <use>
        <svg
          version="1.1"
      ...
      <h1>403</h1>
      <h6>{'You either not login into the portal or you don\'t have access to view the content.'}</h6>
      <Button className="btn btn-primary btn-lg forbidden-access-btn" onClick={() => dispatch(push('/'))}>
        Go Back to Home
      </Button>
    </div>
  );
